                ...
                if (ch == '1') {
                    ...
                    if (friendsEmail.equals("")) {
                        ...
                        for (int i = 0; i < z; i++) {
                            ...
                            mainPageObj.setFriendListModel(singleEmailContactList[i]);
                        }
                    }
                    ...
                    JOptionPane.showMessageDialog(null, "this Account logged in from another device"); 
                }else if (ch == '0') {
                    ...
                    //Anouncment to all online users
                    String[] parts = msg.split("\\$");
